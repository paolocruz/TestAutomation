...
SWIFT_CLASS("_TtC14TestAutomation11AppDelegate")
...
SWIFT_CLASS("_TtC14TestAutomation20DetailViewController")
@interface DetailViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified detailDescriptionLabel;
- (void)configureView;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
@property (nonatomic, strong) NSDate * _Nullable detailItem;
...
SWIFT_CLASS("_TtC14TestAutomation20MasterViewController")
